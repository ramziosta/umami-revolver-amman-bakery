// app/menu/cookies-bars-brownies/[itemId]/page.tsx
'use client';
        ...
        <div className="min-h-screen bg-umami-white">
            ...
            <section className="p-10 lg:p-16 lg:m-12">
                ...
                <nav className="mb-8 text-sm">
                    ...
                    <Link
                        href="/menu/cookies-bars-brownies"
                ...
                <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div className="space-y-8">
                                ...
                                <div className="space-y-4 text-umami-charcoal border-umami-charcoal">
                                    {item.variations.map((variation) => (
                                        <button
                                            ...
                                            className="w-full text-left border p-2 rounded ont-glimp border-umami-charcoal hover:bg-umami-cream/50 transition"
                                        >
                                            <h4 className="font-glimp text-lg">{variation.name}</h4>
                                        </button>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <p className="text-umami-charcoal text-sm mb-4">
                                {item.weight} grams each piece.
                            </p>
