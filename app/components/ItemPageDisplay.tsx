                ...
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="text-xl font-ppneuemontreal  tracking-widest text-umami-charcoal mb-2">
                                    Ingredients
                                </h3>
                        ...
                        {/* Quantity Options */}
                        <div>
                            <h3 className="text-xl font-ppneuemontreal tracking-widest text-umami-charcoal mb-4">
                                Quantity & Pricing
                            </h3>
