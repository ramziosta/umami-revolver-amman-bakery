// app/menu/mille-crepe-cakes/[itemId]/page.tsx
'use client';
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-umami-black text-sm">9 inch (serves 16-18)</p>
                                <p className="text-umami-black text-sm"> 8 inch (serves 12-14)</p>
